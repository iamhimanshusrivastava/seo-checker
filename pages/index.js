...
import OpportunityAudit from "../components/OpportunityAudit";
  ...
  return (
    <Fragment>
      <div className="flex flex-col h-screen justify-between">
        <div>
          <div className="flex flex-col w-full p-4 justify-center mt-10 drawer-end">
            ...
            <div className="text-gray-600 text-center font-bold mt-2">
              See how well your website performs on top 24 SEO checks. Get tips
          ...
          {data && data.lighthouseResult && data.lighthouseResult.audits && (
            <h2 className="flex justify-center mt-8 text-gray-700 italic text-2xl font-extrabold">
              Passed:
            </h2>
          )}
        ...
        <div>
          <div>
            <footer className="p-4 footer bg-gray-100 text-base-content footer-center">
              <div>
                <p>Copyright © 2021 - Seo Checker Tool</p>
              </div>
            </footer>
          </div>
        </div>
